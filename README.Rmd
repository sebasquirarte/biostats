...
[![Total Downloads](https://cranlogs.r-pkg.org/badges/grand-total/biostats)](https://cranlogs.r-pkg.org/)
[![Downloads per Month](https://cranlogs.r-pkg.org/badges/biostats)](https://cranlogs.r-pkg.org/)

<!-- badges: end -->

## Overview

_**biostats**_ is an R package that functions as a toolbox to aid in biostatistics and clinical data analysis tasks and workflows. 
