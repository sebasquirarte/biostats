...
gt::gtsave(clinical_summary, "man/figures/summary_table_example_1.png", zoom = 3, vwidth = 1200)
```
...
```{r message=FALSE, echo=FALSE}
# Save as PNG image for GitHub
gt::gtsave(clinical_summary, "man/figures/summary_table_example_3.png", zoom = 3, vwidth = 1200)
```
