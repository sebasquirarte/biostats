...
_**biostats**_ is an R package that functions as a toolbox for biostatistics and clinical data analysis.
...
gt::gtsave(clinical_summary, "man/figures/summary_table_example_1.png", zoom = 1)
```
...
```{r message=FALSE, echo=FALSE}
# Save as PNG image for GitHub
gt::gtsave(clinical_summary, "man/figures/summary_table_example_2.png",
           zoom = 1)
```
...
```{r message=FALSE, echo=FALSE}
# Save as PNG image for GitHub
gt::gtsave(clinical_summary, "man/figures/summary_table_example_3.png")
```
...
```{r message=FALSE, echo=FALSE}
# Save as PNG image for GitHub
gt::gtsave(clinical_summary, "man/figures/summary_table_example_4.png")
```
