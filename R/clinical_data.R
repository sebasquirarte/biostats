...
#' @param dropout Numeric. Proportion of subjects who dropout (0-1). Default is 0.
#' @param missing Numeric. Overall proportion (0-1) of missing values to be introduced 
#'   across numeric variables qith fixed proportions (biomarker = 15%, weight = 25%, 
#'   response = 60%). Default is 0.
#'   
...
clinical_data <- function(n = 100, 
  ...
  rand_vals <- stats::runif(nrow(clinical_df))
